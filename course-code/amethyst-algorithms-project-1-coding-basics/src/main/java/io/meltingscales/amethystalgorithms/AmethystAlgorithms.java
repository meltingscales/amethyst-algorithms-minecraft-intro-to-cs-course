...
@Mod(AmethystAlgorithms.MODID)
public class AmethystAlgorithms {
  // Define mod id in a common place for everything to reference
  public static final String MODID = "amethystalgorithms";
  // Directly reference a slf4j logger
  private static final Logger LOGGER = LogUtils.getLogger();
  // Create a Deferred Register to hold Blocks which will all be registered under the
  // "amethystalgorithms" namespace
  ...
  // Creates a new Block with the id "amethystalgorithms:example_block", combining the
  // namespace and path
  public static final DeferredBlock<Block> EXAMPLE_BLOCK =
      BLOCKS.registerSimpleBlock(
          "example_block", BlockBehaviour.Properties.of().mapColor(MapColor.STONE));
  // Creates a new BlockItem with the id "amethystalgorithms:example_block", combining the
  // namespace and path
  public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM =
      ITEMS.registerSimpleBlockItem("example_block", EXAMPLE_BLOCK);

  // Creates a new food item with the id "amethystalgorithms:example_id", nutrition 1 and
  // saturation 2
  ...
  // Creates a creative tab with the id "amethystalgorithms:example_tab" for the example
              ...
              CreativeModeTab.builder()
                  .title(
                      Component.translatable(
                          "itemGroup.amethystalgorithms")) // The language key for the title
  ...
  // automatically.
  public AmethystAlgorithms(IEventBus modEventBus, ModContainer modContainer) {
    ...
    // Note that this is necessary if and only if we want *this* class (AmethystAlgorithms)
